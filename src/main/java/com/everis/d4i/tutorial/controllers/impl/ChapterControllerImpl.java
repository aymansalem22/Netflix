...
public class ChapterControllerImpl implements ChapterController {
	...
	@Override
	@ResponseStatus(HttpStatus.OK)
	@PatchMapping(value = RestConstants.RESOURCE_UPDATECHAPTER, produces = MediaType.APPLICATION_JSON_VALUE)
	public NetflixResponse<ChapterRest> updateChapterNameById(Long chapterId, String ChapterName)
			throws NetflixException {
		return new NetflixResponse<>(CommonConstants.SUCCESS, String.valueOf(HttpStatus.OK), CommonConstants.OK,
				chapterService.updateChapterNameById(chapterId, ChapterName));
	}
